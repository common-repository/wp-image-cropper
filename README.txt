...
Tags: image crop, image cropping, wordpress cropping,image cropping plugin, wp image, wp cropping, wordpress image cropping, crop, cropping, thumbnail, featured image, gallery, images, picture, image, image area, cropping, wp image cropping, image preview, cropping, image upload, wordpress media, media upload, crop upload, cropping upload
...
Simply click on any of the cropping button  Crop Image In (PNG), Crop Image In (JPG), Crop Image with (160*90), Crop Image with (320*180, JPG) next click on "Upload to Media" button, Your image will uploaded in wordpress media library. 
...
* Allow to crop image with folowing options "Crop Image In (PNG), Crop Image In (JPG), Crop Image with (160*90), Crop Image with (320*180, JPG)"
